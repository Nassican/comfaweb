                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5 mb-5">
                                    ...
                                    <div class="card-body">
                                        <form id="frmLogin">
                                            ...
                                            <div class="alert alert-danger tex-center d-none" id="alerta" role="alert">

                                            </div>
                                            <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                <button class="btn btn-primary" type="button" onclick="frmLogin(event);">Entrar</button>
                                            </div>
                                            <div class="d-flex align-items-center justify-content-center mt-4 mb-0">
                                                <span>No tienes cuenta?&nbsp;</span><a href="<?php echo base_url; ?>Login/registrarse">Registrarse</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
