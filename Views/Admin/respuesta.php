            ...
            <div class="row">
                <div class="col">
                    <div class="row">
                        ...
                        <p><?php echo $data['solicitud']['nombre'] . " " . $data['solicitud']['apellido']; ?></p>
                    </div>
                </div>
                <div class="col">
                    <span><b>Cedula:</b></span>
                    <p><?php echo $data['solicitud']['documento']; ?></p>
                </div>
                <div class="col">
                    <span><b>Relacion con el paciente:</b></span>
                    <p><?php echo $data['solicitud']['tipousu']; ?></p>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <span><b>Direccion:</b></span>
                    <p><?php echo $data['solicitud']['direccion']; ?></p>
                </div>
                <div class="col">
                    <span><b>Telefono:</b></span>
                    <p><?php echo $data['solicitud']['telefono']; ?></p>
                </div>
                <div class="col">
                    <span><b>Email:</b></span>
                    <p><?php echo $data['solicitud']['email']; ?></p>
                </div>
            </div>
            <div class="row">
                <div class="col">
